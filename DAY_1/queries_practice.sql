...
INSERT INTO students (first_name, last_name, gender, email) VALUES (
    'maulik', 'panchal', 'Male', 'maulikpanchal@gmail.com');
...
FROM
	students
WHERE
	first_name = 'maulik' AND last_name = 'panchal';
...
--sub query
SELECT * from results
where student_id IN (select student_id from students where first_name='maulik')
