...
namespace Web_API.Controllers
{
    ...
    public class CommonController : ControllerBase
    {
        ...
        [HttpGet("CountryList")]
        /*public ActionResult<IEnumerable<Country>> CountryList()
        {
            var countries = _balCommon.CountryList();
        ...
        public ResponseResult AddUserSkill(MissionSkill missionSkill)
        {
            try
            {
                result.Data = _balCommon.AddUserSkill(missionSkill);
                result.Result = ResponseStatus.Success;
            }
            catch (Exception ex)
            {
