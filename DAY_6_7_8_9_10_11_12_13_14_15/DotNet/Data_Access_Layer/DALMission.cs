...
namespace Data_Access_Layer
{
    public class DALMission
    {
        ...
        public string UpdateMission(Missions mission)
        {
            try
            {
                // Retrieve the mission to update from the database
                ...
                // Update all properties of the mission entity
                ...
                existingMission.CountryName = mission.CountryName;
                existingMission.CityName = mission.CityName;
                existingMission.MissionThemeName = mission.MissionThemeName;
                existingMission.MissionSkillName = mission.MissionSkillName;
                existingMission.MissionStatus = mission.MissionStatus;
                existingMission.MissionApplyStatus = mission.MissionApplyStatus;
                existingMission.MissionApproveStatus = mission.MissionApproveStatus;
                existingMission.MissionDateStatus = mission.MissionDateStatus;
                existingMission.MissionDeadLineStatus = mission.MissionDeadLineStatus;
                existingMission.MissionFavouriteStatus = mission.MissionFavouriteStatus;
                existingMission.Rating = mission.Rating;
            ...
            try
            {
                clientSideMissionList = _cIDbContext.Missions
                    ...
                    .Select(m => new Missions
                    {
                        ...
                        MissionImages = !string.IsNullOrEmpty(m.MissionImages) ? $"/UploadMissionImage/Mission/{m.MissionImages}" : "/assets/NoImg.png",
